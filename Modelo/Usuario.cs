...
namespace Modelo
{
    public abstract class Usuario
    {
        ...
        public Usuario(string nombre, string apellido,int dni, string email, string direccion, string telefono, string categoria, DateTime fechaNac, string nombreUsuario,string contraseña)
        {
            this.nombre = nombre;
    ...
    public class registroUsuarios: Usuario
    {
        ...
        public registroUsuarios(string nombre, string apellido, int dni, string email, string direccion, string telefono, string categoria, DateTime fechaNac, string nombreUsuario, string contraseña):base(nombre,apellido,dni,email,direccion,telefono,categoria,fechaNac,nombreUsuario,contraseña)
        {
            this.nombre = nombre;
            this.apellido = apellido;
            this.DNI = dni;
